...
# MotorDriver.MotorRun(trailer1.turn1, 10) # V, after 100-speed change barely moves
...
MotorDriver.MotorRun(trailer2.e1, speed=90) # does noise but pwm not strong enough to move, after 100-speed change - moves.
...
# MotorDriver.MotorRun(trailer3.t2, speed=90) # not strong enough to move, moves
# MotorDriver.stopMotor(trailer3.t2)
# MotorDriver.MotorRun(trailer3.t3, speed=90) # not strong enough to move, moves
