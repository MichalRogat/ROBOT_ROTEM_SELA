...
import _thread
import threading
from functions_2 import GenericFunctions
...
class MinIMU_v5_pi:
    ...
    def enableAccel_Gyro(self, aFullScale, gFullScale):
        ...
        #     self.accel_gyro, self.Accel_Gyro_REG['CTRL1_XL'], self.binConcat([b0_3, b4_5, b6_7]))
        GenericFunctions.writeIMU(
            self.accel_gyro, self.Accel_Gyro_REG['CTRL1_XL'], self.binConcat([b0_3, b4_5, b6_7]))
        ...
        # self.bus.write_byte_data(
        #     self.accel_gyro, self.Accel_Gyro_REG['CTRL2_G'], self.binConcat([b0_3, b4_6, 0]))
        ...
        # self.bus.write_byte_data(
        #     self.accel_gyro, self.Accel_Gyro_REG['CTRL3_C'], 0b00000100)
        GenericFunctions.writeIMU(
            self.accel_gyro, self.Accel_Gyro_REG['CTRL3_C'], 0b00000100)
        self.lock.release()
    ...
    def enableMag(self, mFullScale):
        ...
        # self.bus.write_byte_data(
        #     self.mag, self.Mag_REG['CTRL_REG1'], 0b01010010)
        GenericFunctions.writeIMU(
            self.mag, self.Mag_REG['CTRL_REG1'], 0b01010010)
        ...
        GenericFunctions.writeIMU(
            self.mag, self.Mag_REG['CTRL_REG2'], self.binConcat([0, b1_2, 0, rebootMem, softReset, 0, 0]))

        # default: 0b00000011
        # Low-power off, default SPI, continous convo mode

        # self.bus.write_byte_data(
        #     self.mag, self.Mag_REG['CTRL_REG3'], 0b00000000)
        GenericFunctions.writeIMU(
            self.mag, self.Mag_REG['CTRL_REG3'], 0b00000000)
        ...
        # self.bus.write_byte_data(
        #     self.mag, self.Mag_REG['CTRL_REG4'], 0b00001000)
        GenericFunctions.writeIMU(
            self.mag, self.Mag_REG['CTRL_REG4'], 0b00001000)
    ...
    def readAccelerometer(self):
        ...
        try:
            ...
            AX = GenericFunctions.readIMU(
                self.accel_gyro, self.Accel_Gyro_REG['OUTX_L_XL'], self.Accel_Gyro_REG['OUTX_H_XL'])
            ...
            AY = GenericFunctions.readIMU(
                self.accel_gyro, self.Accel_Gyro_REG['OUTY_L_XL'], self.Accel_Gyro_REG['OUTY_H_XL'])
            # possibly Wire.read to get value from namo AY = Wire.Read
            ...
            AZ = GenericFunctions.readIMU(
                self.accel_gyro, self.Accel_Gyro_REG['OUTZ_L_XL'], self.Accel_Gyro_REG['OUTZ_H_XL'])
    ...
    def readGyro(self):
        ...
        try:
            ...
            GX = GenericFunctions.readIMU(
                self.accel_gyro, self.Accel_Gyro_REG['OUTX_L_G'], self.Accel_Gyro_REG['OUTX_H_G'])
            ...
            GY = GenericFunctions.readIMU(
                self.accel_gyro, self.Accel_Gyro_REG['OUTY_L_G'], self.Accel_Gyro_REG['OUTY_H_G'])
            ...
            GZ = GenericFunctions.readIMU(
                self.accel_gyro, self.Accel_Gyro_REG['OUTZ_L_G'], self.Accel_Gyro_REG['OUTZ_H_G'])
        except:
            # print "Error!"
            self.lock.release()
            return 0, 0, 0
    ...
    def readMagnetometer(self):
        ...
        try:
            ...
            MX = GenericFunctions.readIMU(
                self.mag, self.Mag_REG['OUT_X_L'], self.Mag_REG['OUT_X_H'])
            ...
            MY = GenericFunctions.readIMU(
                self.mag, self.Mag_REG['OUT_Y_L'], self.Mag_REG['OUT_Y_H'])
    ...
    def binConcat(lst, retStr=False):
        ...
        strValue = '0b' + \
            ''.join([x if type(x) is str else bin(x)[2:] for x in lst])
        if retStr == False:
